...
| R14 | Performance/long-file memory (whole-file arrays in memory; STFT copies) | L→M | Untested beyond short clips | Add long-file benchmark when corpus includes full songs (M23 backlog) | M23+ |
